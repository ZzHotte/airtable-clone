...
export function BaseTopBar() {
  return (
    <div className="px-6 py-3 border-b border-gray-200 flex items-center justify-between bg-white relative">
      <div className="flex items-center gap-4">
        {/* Base Title */}
        <div className="flex items-center gap-2">
          {/* Icon with gray rounded square background */}
          <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgb(85, 90, 100)' }}>
            <svg
              width="24"
              height="20"
              viewBox="0 0 200 170"
